...
public class Main {
	...
	public static void main(String[] args) {
		...
		while (menuSelect) {
			...
			// 메인메뉴(버거 선택 || 버거만, 세트)
			int burger = kioskMain.nextInt(); // 햄버거 // 햄버거의 Index 값 (-1한 값)
			switch (burger) {
			case 1:
			case 2:
			case 3:
			...
			case 7:
				...
				while (plustopping) {
					...
					System.out.println("1. 토마토 [600 \u20A9]\t 2.치즈 [800 \u20A9]\t 3. 베이컨 [1,600 \u20A9]\t 4. 비프패티 [2,500 \u20A9]\n5. 추가하지 않음");
				...
				while (sideMenu) {
					...
					case 6:
						...
						while (payment) {
							...
							case 9:
								System.out.println("햅버거 번호 : " + burger);
								System.out.println("사이드 번호 : " + side);
